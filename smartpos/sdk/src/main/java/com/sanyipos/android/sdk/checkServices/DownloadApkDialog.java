...
public class DownloadApkDialog extends Dialog {
    ...
    public DownloadApkDialog(Context context, Map<String, String> data, String deviceId, IDownloadListener listener) {
        super(context);
        // TODO Auto-generated constructor stub
        mContext = context;
        this.data = data;
    ...
    public class downloadApkThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                fileName = String.format("%s-%d.apk", "app", Integer.parseInt(data.get("version")));
