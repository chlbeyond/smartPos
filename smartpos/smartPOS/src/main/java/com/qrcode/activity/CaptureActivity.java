...
import com.qrcode.decode.CaptureActivityHandler;
import com.qrcode.decode.Constant;
import com.qrcode.decode.InactivityTimer;
...
public class CaptureActivity extends Activity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCropLayout = (RelativeLayout) findViewById(R.id.capture_crop_view);
        ...
        findViewById(R.id.exitView).setOnClickListener(new OnClickListener() {
    ...
    public void handleDecode(String result) {
        ...
        data.putExtra("serial_number", result);
        this.setResult(RESULT_CODE_CAMERA, data);
        CaptureActivity.this.finish();
    }
