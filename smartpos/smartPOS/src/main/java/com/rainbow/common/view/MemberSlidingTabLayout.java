 ...
 * layout.
 */
public class MemberSlidingTabLayout extends HorizontalScrollView {
	...
	private final MemberSlidingTabStrip mTabStrip;

	public MemberSlidingTabLayout(Context context) {
		this(context, null);
	}

	public MemberSlidingTabLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public MemberSlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		mTabStrip = new MemberSlidingTabStrip(context);
	 ...
	 * {@link MemberSlidingTabLayout} you are required to set any
	...
	protected TextView createDefaultTabView(Context context) {
		...
		textView.setTextSize(getResources().getDimensionPixelOffset(R.dimen.order_fragment_tab_size));
		return textView;
	}
