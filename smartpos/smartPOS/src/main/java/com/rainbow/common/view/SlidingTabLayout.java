...
//        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, context.getResources().getDimension(R.dimen.table_status_bottom_text));
//        textView.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        int i = getResources().getDimensionPixelOffset(R.dimen.table_status_bottom_text);
		textView.setTextSize(i);
        textView.setTextColor(Color.WHITE);
        textView.setBackgroundResource(R.drawable.subcat_button_selector);
		return textView;
	}
