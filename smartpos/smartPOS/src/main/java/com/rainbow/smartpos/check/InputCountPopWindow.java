...
public class InputCountPopWindow {
    ...
    public InputCountPopWindow(View v, Activity activity, OnSureListener onSureListener) {
        this.parentView = v;
    ...
    public void show() {
        View contentView = LayoutInflater.from(activity).inflate(R.layout.input_count_dialog_layout, null);
    ...
    private void initView(View view) {
        ...
        inputNumber = (TextView) view.findViewById(R.id.textView_inputNumber);
        btnClear = (ImageButton) view.findViewById(R.id.buttonNumPadClear);
        btnSure = (TextView) view.findViewById(R.id.sure_btn);
        btnDot = (Button) view.findViewById(R.id.buttonNumPadDot);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.buttonNumPadClear:
                    ...
                    break;
                case R.id.richScan:
                    activity.startActivityForResult(new Intent(activity, CaptureActivity.class), CaptureActivity.RESULT_CODE_CAMERA);
                    break;
    ...
    private void buttonSureClick() {
        try {
            onSureListener.onSureClick(Double.valueOf(inputNumber.getText().toString()));
        } catch (Exception e) {
            e.printStackTrace();
        }
