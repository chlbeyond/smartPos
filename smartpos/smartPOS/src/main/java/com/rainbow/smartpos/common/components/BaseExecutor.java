...
//        }
        ...
        command.add("/system/bin/chmod -R 755 " + Constants.INTERNAL_LOCATION );
    ...
    protected void createOrRestoreConfiguration(String confFilename, String fileName) throws Exception {
        ...
        EXTERNAL_DIR = Environment.getExternalStorageDirectory().getPath() + "/smartpos/";
...
//                Environment.getExternalStorageDirectory().getPath() + "/smartpos/conf/" + fileName), confValue, "UTF-8"
//        );
