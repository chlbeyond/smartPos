...
import com.rainbow.smartpos.printer.ESCUtils;
import com.rainbow.smartpos.printer.PrinterCallback;
import com.rainbow.smartpos.printer.TableItem2;
...
public class AidlUtil {
    ...
    public void setDarkness(int index) {
        ...
        try {
            woyouService.sendRAWData(ESCUtils.setPrinterDarkness(k), null);
    ...
    public void printText(String content, float size, boolean isBold, boolean isUnderLine) {
        ...
        try {
            if (isBold) {
                woyouService.sendRAWData(ESCUtils.boldOn(), null);
            } else {
                woyouService.sendRAWData(ESCUtils.boldOff(), null);
            }

            if (isUnderLine) {
                woyouService.sendRAWData(ESCUtils.underlineWithOneDotWidthOn(), null);
            } else {
                woyouService.sendRAWData(ESCUtils.underlineOff(), null);
            }
    ...
    *打印图片
     ...
     * 打印表格
     */
    public void printTable(LinkedList<TableItem2> list) {
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
