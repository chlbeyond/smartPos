...
public class NetworkUtil {
	...
	private static HttpClient pollingHttpClient = null;
	
	private static HttpGet pollingHttpGet = null;
	...
	public static synchronized HttpClient getPollingHttpClient() {
		if (pollingHttpClient == null) {
			...
			pollingHttpClient = new DefaultHttpClient(httpParams);
		}

		return pollingHttpClient;
	}	
	
	public static synchronized HttpGet getPollingHttpGet(String url){
		if(pollingHttpGet == null){
			pollingHttpGet = new HttpGet(url);
		}
		return pollingHttpGet;
	}
